                                ...
                                <?php 
                                    if(count($meet_data) > 0){
                                        foreach($meet_data as $meet_datum):
                                            if($meet_datum['meet_content_where'] == 'Zoom'):
                                ?>
                                <div class="card">
                                    <div class="card-body pb-1">
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <div class="w-100">
                                                ...
                                                <p class="text-muted"><small>Admin | <?= $meet_datum['meet_time_created']?> <span class="mx-1"></span> <span></span></small></p>
                                            </div> <!-- end w-100-->
                                        </div> <!-- end d-flex -->
                                        ...
                                        <div class="mt-3 ms-1 me-1">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="mt-1">
                                                        ...
                                                        <p class="font-16 m-0 mt-1 mb-1"><strong>Start Time: </strong><?= $meet_datum['meet_time_started']?></p>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <?php elseif($meet_datum['meet_room_status'] == 'Close'):?>
                                            ...
                                            <?php elseif($meet_datum['meet_room_status'] == 'Closed'):?>
                                                <div class="text-center mt-3">
                                                    <p class="text-primary"><i><strong>Note: </strong> This meeting has been closed, and ended.</i></p>
                                                </div>    
                                            <?php endif;?>
                                        </div>
                                        ...
                                        <div class="mt-3">
                                            ...
                                            <div class="d-flex mb-2">
                                                ...
                                                <div class="w-100">
                                                    <form action="saveMeetComment" method="POST">
                                                        <input type="hidden" name="<?= csrf_token() ?>" value="<?= csrf_hash() ?>" />
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body m-2">
                                                <form method="POST" action="editMeetCom" enctype="multipart/form-data">
                                                    <input type="hidden" name="<?= csrf_token() ?>" value="<?= csrf_hash() ?>" />
                                                    <div class="row"> 
                                                        <div class="mb-2">
                                    ...
                                    <div class="modal-dialog modal-sm">
                                        <div class="modal-content modal-filled bg-danger">
                                            ...
                                            <div class="text-center">
                                                ...
                                                <form action="deleteMeetCom" method="post">
                                                    <input type="hidden" name="<?= csrf_token() ?>" value="<?= csrf_hash() ?>" />
