                ...
                <div class="content-page">
                    ...
                    <div class="row">
                        <div class="col-lg-8">
                            ...
                            <?php foreach($order_data as $order_datum):?>
                            ...
                            <div class="card">
                                <div class="card-body pb-1">
                                    ...
                                    <div class="mt-2 ms-1 me-1">
                                        <p class="font-16 m-0 mt-3 mb-1"><strong><?=$order_datum->textContent?></strong></p>
                                        <a href="<?=$order_datum->getAttribute('href')?>" class="btn btn-sm btn-primary" title="click to read the recent DepEd order" 
                                    ...
                                    <div class="my-3">
                                        <div class="row">
                                            ...
                                            <h5 class="text-center mt-5">
                                                "There are no Recent Orders published yet, by DepED Official Website !</h5>
                                            </div>
                                        </div>
                                    </div>
                                </div> <!-- end card-body -->
