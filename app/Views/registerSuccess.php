...
<head>
        <meta charset="utf-8" />
        <title>Registration Complete | APTM Official Website</title>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="text-center w-100 m-auto">
                                    <h4 class="text-dark-50 text-center mt-0 fw-bold">Thank You !</h4>
                                    <p class="mb-4 mt-3">
                                        You're account registration was submitted successfully, 
                                        please wait for the message that will be sent 
                                        to your provided email. We will verify your information 
                                        to see if you're qualified to become a member of this Association. 
                                        If you don't receive an email from us that means your email address is not valid.</p>
                                    <!-- <p class="mb-4 mt-3">Please pay your <strong> Membership Fee amounting to <i>300.00 pesos</i> </strong>
                                     to your <strong> APTM Division's Treasurer manually or pay online using PayPal</strong> and wait for the 
                                     <strong> Administrator Approval </strong> from your account registration.</p> -->
                                </div>
        ...
        <script>
            ...
            paypal.Buttons({
                ...
                return actions.order.capture().then(function(details) {
                    ...
                    ', Your PAYMENT TRANSACTION using PayPal was SUCCESSFUL, a notification email will be send to your email provided, once the ADMIN APPROVED your Account Registration. Thank You.');
                });
                }
