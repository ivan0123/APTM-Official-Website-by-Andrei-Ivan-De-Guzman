...
<head>
        <meta charset="utf-8" />
        <title><?= $meta_title?> | APTM Official Website</title>
    ...
    <style>
        ...
        <div class="navbar-custom topnav-navbar topnav-navbar-dark">
            <div class="container-fluid">
                ...
                <!-- LOGO -->
                <a href="<?=base_url()?>/AptmController/view_home" class="topnav-logo">
                    <span class="topnav-logo-lg">
                        <img src="<?=base_url()?>/public/assets/images/aptm/mini_logo.png" alt="" height="30">
                    </span>
                    <span class="topnav-logo-sm">
                        <img src="<?=base_url()?>/public/assets/images/aptm/logo_no_text.png" alt="" height="30">
                    </span>
                </a>
                ...
                <ul class="list-unstyled topbar-menu float-end mb-0">
                    ...
                    <li>
                        <a href="<?=base_url('AdminController/view_home')?>" class="btn btn-primary btn-rounded me-2" href="#" style="margin-top: 15px;" 
                            title="click me, to visit Admin Page">
                    ...
                    <li class="dropdown notification-list ms-1">
                        <a onclick="fetchNotif()" type="button" class="nav-link dropdown-toggle arrow-none" data-bs-toggle="dropdown" 
                            id="topbar-notifydrop" role="button" aria-haspopup="true" 
                            aria-expanded="false">
                            <i class="dripicons-bell noti-icon"></i>
                            <div id="notifCount">
                                <span class="badge bg-danger rounded-pill" 
                                    style="position: relative; bottom: 60px; left: 15px;"><?=$not_seen_notif_count?></span>
                            </div>
                        </a>
                        <div class="dropdown-menu dropdown-menu-end dropdown-menu-animated dropdown-lg" aria-labelledby="topbar-notifydrop">
                            ...
                            <div id="notifList" data-simplebar>
                            </div>
                            ...
                            <!-- All-->
                            <a href="<?php echo base_url('AptmController/view_notif');?>" class="dropdown-item text-center text-primary notify-item notify-all">
                                View All
                            </a>
                    ...
                    <li class="dropdown notification-list">
                        ...
                        <div class="dropdown-menu dropdown-menu-end dropdown-menu-animated topbar-dropdown-menu profile-dropdown" aria-labelledby="topbar-userdrop">
                            ...
                            <!-- item-->
                            <a href="<?php echo base_url('AptmController/view_profile');?>" class="dropdown-item notify-item">
        ...
        <div class="container-fluid">
            ...
            <div class="wrapper">
                ...
                <div data-simplebar class="leftside-menu leftside-menu-detached pb-3" style="max-height: 515px">

                    <div class="leftbar-user mb-0">
                        <div>
                            <img src="<?=$session->get('l_profile_pic');?>" alt="user-image" height="42" class="rounded-circle shadow-sm">
                            <span class="leftbar-user-name"><?=$session->get('l_fname').' '.$session->get('l_lname');?></span>
                            <small><?=$session->get('l_division');?></small><br>
                            <small><?=$session->get('l_type');?></small>
                        </div>
                    </div>
                    ...
                    <ul class="side-nav">
                        ...
                        <li class="side-nav-item">
                            <a href="<?php echo base_url('AptmController/view_home');?>" class="side-nav-link">
                        ...
                        <li class="side-nav-item">
                            <a href="<?php echo base_url('AptmController/view_announcement');?>" class="side-nav-link">
                        ...
                        <li class="side-nav-item">
                            <a href="<?php echo base_url('AptmController/view_news');?>" class="side-nav-link">
                        ...
                        <li class="side-nav-item">
                            <a href="<?php echo base_url('AptmController/view_forum');?>" class="side-nav-link">
                        ...
                        <li class="side-nav-item">
                            ...
                            <div class="collapse" id="sidebarEmail">
                                <ul class="side-nav-second-level">
                                    <li>
                                        <a href="<?php echo base_url('AptmController/view_zoom');?>">Zoom</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo base_url('AptmController/view_jitsiMeet');?>">Jitsi Meet</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                        ...
                        <li class="side-nav-item">
                            <a data-bs-toggle="collapse" href="#deped" aria-expanded="false" aria-controls="deped" class="side-nav-link">
                                <i class="uil-book-reader"></i>
                                <span> DepED </span>
                                <span class="menu-arrow"></span>
                            </a>
                            <div class="collapse" id="deped">
                                <ul class="side-nav-second-level">
                                    <li>
                                        <a href="<?php echo base_url('AptmController/view_depedOrders');?>">Recent Orders</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo base_url('AptmController/view_depedMemo');?>">Recent Memoranda</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                        ...
                        <li class="side-nav-item">
                            <a href="<?php echo base_url('AptmController/view_chatRoom');?>" class="side-nav-link">
                                <i class="uil-comments"></i>
                                <span> Chat Room </span>
                            </a>
                        </li>

                        <?php if ($session->get('l_type') == "treasurer"):?>
                        <li class="side-nav-item">
                            <a href="<?php echo base_url('AptmController/view_treasurerTask');?>" class="side-nav-link">
                                <i class="uil-money-bill-stack"></i>
                                <span> Treasurer's Task </span>
                            </a>
                        </li>
                        <?php endif;?>
                    </ul>
...
// close the backdrop of modal
            ...
            $(document).ready(function (){
                $('#tbl_tres_pue').DataTable();
            });
// x

// CKEDITOR PLUGIN
            ClassicEditor
                .create(document.querySelector('#txtForumCreate'), {
                        ...
                        if(len != 0){
                            for(var i=0; i<len; i++){
                                ...
                                if(notifStat == 'not seen'){
                                    var notifList = "<form action='visitNotif' method='post'>" +
...
// FETCH MEMBER DATA FOR SEARCH MEMBER TO SEND MESSAGE
// nasa sticky
// x

// PREVENT CERTAIN CHAR TYPE FOR INPUT
